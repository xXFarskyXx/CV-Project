...
SQUARE_SIZE = 43  # millimeters (change it according to printed size)
...
calib_data_path = "..\img"
calib_data_path = os.path.join(current_directory, calib_data_path)
...
current_directory = os.path.dirname(os.path.abspath(__file__))
image_dir_path = "../img"
image_dir_path = os.path.join(current_directory, image_dir_path)
